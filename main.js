import { inicializarCarrinho } from "./src/menuChart";
...
for (const produtoCatalago of catalago) {
    const cartaoProduto = `<div id="card-produto-${produtoCatalago.id}" class="border-solid border-2 w-48 m-2 border-sky-500">
<img 
