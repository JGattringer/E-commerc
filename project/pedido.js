import { lerLocalStorage, desenharProdutoCarrinhoFinal } from "./src/ultilitys";
...
function criarPedidoHistorico(pedidoComData) {
    ...
    for(const idProduto in pedidoComData.pedido) {
        desenharProdutoCarrinhoFinal(idProduto, `container-pedidos-${pedidoComData.dataPedido}`, pedidoComData.pedido[idProduto])
    }
}
